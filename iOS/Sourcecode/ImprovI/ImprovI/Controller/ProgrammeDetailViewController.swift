...
class ProgrammeDetailViewController: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        self.vwInfo.layer.borderWidth = 1
        self.vwInfo.layer.borderColor = Constant.UI.foreColor.cgColor
        ...
        self.vwDailyTask.layer.cornerRadius = 10
        self.vwDailyTask.layer.borderWidth = 1
        self.vwDailyTask.layer.borderColor = Constant.UI.foreColor.cgColor
